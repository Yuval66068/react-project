...
const CardView = () => {
  ...
  const [data, error, isLoading, apiCall] = useAPI(); // Assuming useAPI is correctly implemented

  const navigate = useNavigate();

  useEffect(() => {
    // Fetch card details when cardId changes
    apiCall(METHOD.CARDS_GET_ONE, { id: cardId }); // Ensure useAPI supports this method
  }, [apiCall, cardId]);
